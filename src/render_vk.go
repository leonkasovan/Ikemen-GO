...
func (r *Renderer_VK) newTexture(width, height, depth int32, filter bool) (Texture, error) {
	t := &Texture_VK{width: width, height: height, depth: depth, filter: filter, mipLevels: 1, uvst: [4]float32{0, 0, 1, 1}, residency: ResidentDeviceLocal}
...
func (r *Renderer_VK) newDataTexture(width, height int32) (Texture, error) {
	t := &Texture_VK{width: width, height: height, depth: 32 * 4, filter: false, mipLevels: 1, uvst: [4]float32{0, 0, 1, 1}, residency: ResidentDeviceLocal}
	format := t.MapInternalFormat(Max(t.depth, 8))
...
func (r *Renderer_VK) newCubeMapTexture(widthHeight int32, mipmap bool, lowestMipLevel int32) (Texture, error) {
	t := &Texture_VK{width: widthHeight, height: widthHeight, depth: 128, filter: false, mipLevels: 1, uvst: [4]float32{0, 0, 1, 1}, residency: ResidentDeviceLocal}
	if mipmap {
...
func (r *Renderer_VK) newPaletteTexture() Texture {
	t := &Texture_VK{width: 256, height: 1, depth: 32, filter: false, mipLevels: 1, uvst: [4]float32{0, 0, 1, 1}, palSlot: true, residency: ResidentDeviceLocal}
...
func (r *Renderer_VK) newDummyCubeMapTexture() (*Texture_VK, error) {
	t := &Texture_VK{width: 1, height: 1, depth: 8, filter: false, mipLevels: 1, uvst: [4]float32{0, 0, 1, 1}, residency: ResidentDeviceLocal}
	format := t.MapInternalFormat(Max(t.depth, 8))
...
func (r *Renderer_VK) CreateRenderTargetTexture(width, height uint32, numSamples int32, main bool) *Texture_VK {
	t := &Texture_VK{width: int32(width), height: int32(height), depth: 32, filter: false, mipLevels: 1, uvst: [4]float32{0, 0, 1, 1}, residency: ResidentDeviceLocal}
...
func (r *Renderer_VK) addPalTexture() {
	...
	t := &Texture_VK{width: int32(r.palTexture.size), height: int32(r.palTexture.size), depth: 32, filter: false, mipLevels: 1, uvst: [4]float32{0, 0, 1, 1}, residency: ResidentDeviceLocal}
...
func (r *Renderer_VK) createShadowMapTexture(widthHeight int32) *Texture_VK {
	t := &Texture_VK{width: widthHeight, height: widthHeight, depth: 96, filter: false, mipLevels: 1, uvst: [4]float32{0, 0, 1, 1}, residency: ResidentDeviceLocal}
	t.sampler = r.GetSampler(VulkanSamplerInfo{TextureSamplingFilterNearest, TextureSamplingFilterNearest, TextureSamplingWrapClampToEdge, TextureSamplingWrapClampToEdge})
